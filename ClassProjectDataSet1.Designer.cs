...
namespace _19110085_NguyenTranKhai_QLSV {
    ...
    public partial class ClassProjectDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ClassProjectDataSet1.xsd";
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[std] WHERE (([id] = @Original_id) AND ([fname] = @Original_fna" +
                ...
                "] = @Original_gender) AND ([phone] = @Original_phone))";
...
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std] SET [id] = @id, [fname] = @fname, [lname] = @lname, [bdate] = @bdate, [gender] = @gender, [phone] = @phone, [address] = @address, [picture] = @picture WHERE (([id] = @Original_id) AND ([fname] = @Original_fname) AND ([lname] = @Original_lname) AND ([bdate] = @Original_bdate) AND ([gender] = @Original_gender) AND ([phone] = @Original_phone));
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
        ...
        public virtual int Delete(int Original_id, string Original_fname, string Original_lname, System.DateTime Original_bdate, string Original_gender, string Original_phone) {
        ...
        public virtual int Insert(int id, string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture) {
        ...
        public virtual int Update(int id, string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture, int Original_id, string Original_fname, string Original_lname, System.DateTime Original_bdate, string Original_gender, string Original_phone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture, int Original_id, string Original_fname, string Original_lname, System.DateTime Original_bdate, string Original_gender, string Original_phone) {
